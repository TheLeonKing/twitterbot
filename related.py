...
def printRelated(mode):
    ...
    print '\nThe database currently contains the following ' + str(mode) + ': ' + ', '.join(fetchRelated(mode)) + '\n'
...
def updateKeywords():
    ...
    userItem = raw_input('For which of those do you want to find related keywords? ')
